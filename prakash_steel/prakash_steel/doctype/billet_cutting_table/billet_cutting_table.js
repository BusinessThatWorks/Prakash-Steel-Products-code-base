// // Put this whole block in a Client Script for the parent doctype (e.g. Billet Cutting table)
// frappe.ui.form.on('Billet Cutting table', {
//     refresh(frm) {
...
// frappe.ui.form.on('Billet Cutting table Item', {
