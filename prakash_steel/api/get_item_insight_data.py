...
@frappe.whitelist()
def get_item_insight_data(from_date=None, to_date=None, item_code=None):
	"""
...
def get_sales_data(item_code, from_date, to_date):
	...
	pending_sales_order_qty = flt(pending_so_qty[0].pending_qty, 2) if pending_so_qty and pending_so_qty[0].pending_qty else 0
...
def get_purchase_data(item_code, from_date, to_date):
	...
	pending_purchase_order_qty = flt(pending_po_qty[0].pending_qty, 2) if pending_po_qty and pending_po_qty[0].pending_qty else 0
